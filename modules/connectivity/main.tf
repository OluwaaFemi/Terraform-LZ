## Wrapper module around the upstream AVM connectivity pattern and supporting AVM resource modules.
## This keeps the root module thin while preserving the same external input schema.
